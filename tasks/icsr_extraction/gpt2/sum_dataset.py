...
class LineByLineSumTextDataset(Dataset):
    ...
    def __init__(self, tokenizer: PreTrainedTokenizer, split: Dataset, text_column:str, summary_column:str, block_size: int, bos_tok:str, eos_tok:str,
        ...
        # logger.info("Creating features from dataset at %s", dataset_name)
        ...
        if self.use_stream_mode:
            ...
            src_lines = [self.instruction + line if self.instruction else line for line in split[text_column]]
            tgt_lines = split[summary_column]
