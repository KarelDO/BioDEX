...
def main():
    ...
    if data_args.dataset_name is not None:
        # Downloading and loading a dataset from the hub or load from local disk.
        if os.path.isdir(data_args.dataset_name):
            ...
            logger.info(
                f"Loading dataset from Hugging Face Hub: {data_args.dataset_name}."
            )
